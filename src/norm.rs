...
static REPLACE_MAP: LazyLock<HashMap<&str, &str>> = LazyLock::new(|| {
...
pub static PUNCTUATION_SYMBOLS: LazyLock<Vec<&str>> = LazyLock::new(|| {
...
const PAD: &str = "_";
pub static NORMAL_SYMBOLS: LazyLock<Vec<&str>> = LazyLock::new(|| {
...
pub static SYMBOLS: LazyLock<Vec<&str>> = LazyLock::new(|| {
